...
public class min_pairs {
    public static void main(String[] args) {
        ArrayList<Integer> a1 = new ArrayList<Integer>(Arrays.asList(-1, 5, 10, 25, 3));
        ArrayList<Integer> a2 = new ArrayList<Integer>(Arrays.asList(26, 134, 135, 15, 17, -10));
    ...
    public static void min_pair(ArrayList<Integer> a1, ArrayList<Integer> a2) {
        ...
        for (int x : a1) {
            int lb = Math.abs(Collections.binarySearch(a2, x) + 1);
